...
public class index {
	...
	public static void main(String[] args) {
				...
				if (sesionNormal) {
					if (pointerU.perfil.equals("1")) {
						...
						case "1":
							...
							proyecto3 = new proyectos(idProyecto, nombreProyecto, descripcion, pointerU, presupuesto,
									null);
		...
		case "2":
			...
			usuario2 = new usuarios(idUsuario, nombre, perfil, usuario, contrasena);
			usuarios.insertarNuevoUsuario(headU, usuario2, pointerU);
			break;
		default:
